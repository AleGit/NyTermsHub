...
class ParseBasicSyntaxTests: XCTestCase {
    ...
    func testParseHWV062fof1() {
        ...
        let conjunction = forall[Position(array:[2,2,2])]!
        ...
        let b = nodes[Position(array:[1,2,2,2])]!   // nodes[0][[2,2,2]] position 1 is array index 0
        XCTAssertEqual(a, b)
